...
void scene_structure::display_gui()
{
    ...
    ImGui::Checkbox("Depth Buffer", &gui.enable_depth_buffer);

    ImGui::SliderFloat("camel-x", &camel.model.translation.x, -2.0f, 2.0f);
    ImGui::SliderFloat("FoV", &camera_projection.field_of_view, 10.f * Pi / 180.f, 150.f * Pi / 180.f);
    ImGui::SliderFloat("Frequency", &gui.frequency, 0, 120);
}
